...
const PublicResults = () => {
  ...
  const fetchResults = async () => {
    try {
      const response = await axios.get(`/api/events/public/${votingUrl}/results`);
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm text-primary-600 font-medium">Public Results</span>
          </div>
        </div>
        ...
        <div className="mt-8 card">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Want to Participate?</h3>
            <p className="text-gray-600 mb-6">
              {event.isCurrentlyActive 
                ? "This event is still active! Log in to cast your vote."
                : "This event has ended. Log in to participate in future events."
              }
            </p>
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-center">
            ...
            <div>
              <h4 className="text-sm font-medium text-blue-800">Public Results</h4>
              <p className="text-sm text-blue-700 mt-1">
                These are the public voting results. For real-time updates and to participate in voting, please log in to your account.
              </p>
            </div>
          </div>
        </div>
